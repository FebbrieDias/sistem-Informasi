...
<div class="d-flex align-items-center justify-content-between mb-4 mt-2">
    <h4 class="font-weight-bold p-0 m-0">Piutang</h4>
...
<button type="button" class="btn btn-md btn-info mt-3 mb-4" style="border-radius: 20px;" data-toggle="modal" data-target="#tambah">
    <i class="feather icon-plus" style="font-size: 15px;"></i> Tambah Piutang
</button>
        ...
        <table class="table card-table " id="table-datatable">
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        <td><?php echo $no; ?></td>
                        <!-- <td>PTG-000<?php echo $no++; ?></td> -->
                        <td><?php echo date('d-m-Y', strtotime($d['piutang_tanggal'])); ?></td>
                        <td><?php echo $d['piutang_keterangan']; ?></td>
                        <td><?php echo "Rp. " . number_format($d['piutang_nominal']) . " ,-"; ?></td>
                        <td>
                            <button type="button" class="btn btn-warning btn-md text-white" style="border-radius: 20px;" data-toggle="modal" data-target="#edit_piutang_<?php echo $d['piutang_id'] ?>">
                                <i class=" feather icon-edit" style="font-size: 15px;"></i>
                            </button>
                            <button type="button" class="btn btn-danger btn-md text-white" style="border-radius: 20px;" data-toggle="modal" data-target="#hapus_piutang_<?php echo $d['piutang_id'] ?>">
                                <i class="feather icon-trash" style="font-size: 15px;"></i>
                            </button>

                            <form action="./piutang_update.php" method="post">
                                <div class="modal modal-fill-in fade" id="edit_piutang_<?php echo $d['piutang_id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content bg-white" style="border-radius: 10px;">
                                            ...
                                            <div class="modal-body">
                                                <div class="form-group" style="width:100%; margin-bottom:20px">
                                                    ...
                                                    <input type="date" name="tanggal" required="required" class="form-control" value="<?php echo $d['piutang_tanggal'] ?>">
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <label>Keterangan</label>
                                                    <textarea name="keterangan" class="form-control" rows="4"><?php echo $d['piutang_keterangan'] ?></textarea>
                                                </div>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary" style="border-radius: 20px;" data-dismiss="modal">
                            ...
                            <div id="hapus_piutang_<?php echo $d['piutang_id']; ?>" class="modal modal-fill-in fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content bg-white" style="border-radius: 20px;">
                                        <div class="modal-body text-center">
                                            ...
                                            <div class="mt-4">
                                                ...
                                                <a role="button" href="./piutang_hapus.php?id=<?php echo $d['piutang_id'] ?>" style="border-radius: 10px;" type="submit" class="btn btn-danger">Hapus</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
