...
mysqli_query($koneksi, "insert into transaksi values (NULL,'$tanggal','$klien','$jenis','$kategori','$nominal','$keterangan','$bank')") or die(mysqli_error($koneksi));
header("location:transaksi.php?alert=berhasil-tambah");
